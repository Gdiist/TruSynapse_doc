...
(3) 设置 PYTHONPATH（使替换后的库可被 Python 识别）
...
4. 挂载 hugetlbfs（根据所需的大页大小选择 pagesize，常用 1G 或 2M）
...
.. code-block:: bash
    ...
    # 或使用 2M 大页
    # sudo mount -t hugetlbfs none /mnt/huge -o pagesize=2M,mode=0777
